...
public class Const {
    ...
    public static final String URL_MOBILE = "http://news.csdn.net/news";// 移动
    public static final String URL_CLOUD = "http://news.csdn.net/news";// 云计算
    public static final String URL_SD = "http://news.csdn.net/news";// 软件研发
    public static final String URL_PROGRAMMER = "http://news.csdn.net/news";// 程序员
    ...
    public static final String ROBOT_KEY="dd508ce07f084d6f9b4bb4aadaacc901";
